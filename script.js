$(document).ready(function() {
    ...
    function getWeather(city) {
        ...
        $.ajax({
            url: `https://allow-any-origin.appspot.com/http://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${APIKEY}&units=imperial`,
            method: "GET"
            ...
            $.ajax({
                url: `https://allow-any-origin.appspot.com/http://api.openweathermap.org/data/2.5/uvi/forecast?appid=${APIKEY}&lat=${lat}&lon=${lon}&cnt=1`,
                method: "GET"
            ...
            $.ajax({
                url: `https://allow-any-origin.appspot.com/http://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${lon}&appid=${APIKEY}&units=imperial&exclude=current,minutely,hourly`,
                method: "GET"
    ...
    function renderWeatherDisplay(response, responseUV) {
        ...
        $("h2").append($("<img>").attr("src", `https://allow-any-origin.appspot.com/http://openweathermap.org/img/w/${response.weather[0].icon}.png`));
    ...
    function renderFiveDayForecast(response) {
        ...
        for(var i = 1; i <= 5; i++){
            ...
            $("<p>").append($("<img>").attr("src", `https://allow-any-origin.appspot.com/http://openweathermap.org/img/w/${response.daily[i].weather[0].icon}.png`)),
